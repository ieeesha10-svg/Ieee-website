...
import AboutImageFallback from "../../assets/images/about-image.webp";
    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col items-center justify-center lg:items-start lg:justify-start text-center lg:text-left gap-6">
          ...
          <h1 className="uppercase max-w-xl text-4xl md:text-7xl font-gotham font-bold text-foreground leading-tight">
            Engineering the <span className='text-primary-light'>Future</span>, Together
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 w-[80%] sm:w-auto">
            ...
            <Link
              to="/events"
              className={`${user ? "bg-primary-linear text-white hover:opacity-85 hover:scale-[1.02]" : "border border-border text-foreground hover:bg-card hover:border-primary/50"} font-semibold rounded-full px-6 py-3 flex items-center justify-center w-full sm:w-auto transition-all duration-300`}
            >
              Explore Events
            </Link>
          </div>
        ...
        <div className="relative rounded-2xl">
          ...
          <img
            src={imgFailed ? AboutImageFallback : "https://res.cloudinary.com/xcdyzvmc/image/upload/v1785588071/about-image.jpg_r4gq2q.jpg"}
