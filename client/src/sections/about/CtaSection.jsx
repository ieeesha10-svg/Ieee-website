    ...
    <section className="py-16 md:py-24 about-page-bg">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-brand-linear rounded-2xl md:rounded-3xl p-10 md:p-16 text-center">
          ...
          <Link to="/committees" className="mt-6 bg-white text-primary font-semibold rounded-full px-6 py-3 inline-flex items-center gap-2 mx-auto transition-all duration-300 hover:opacity-90 hover:scale-[1.02]">
