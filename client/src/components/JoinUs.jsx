    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-[313px] lg:max-w-[1024px] px-4">
        ...
        <div className="flex flex-row items-center justify-center gap-3 lg:gap-6">
          {/* Primary Button */}
          <Link to="/signup" className="flex justify-center items-center w-[135px] h-[38px] lg:w-[269px] lg:h-[76px] bg-gradient-to-r from-[#0096FF] to-[#33B5FF] rounded-[4px] lg:rounded-[8px] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)] hover:shadow-[0_0_25px_rgba(0,150,255,0.7)] hover:-translate-y-1 transition-all duration-300">
