export const navItems = [
  ...
  { to: '/dashboard/users', label: 'Members', icon: 'Users', title: 'Members', sub: '12 students', buttonText: 'Export CSV', buttonIcon: 'Download' },
  { to: '/dashboard/events', label: 'Events', icon: 'Calendar', title: 'Events', sub: '8 events managed', buttonText: 'Create New Event', buttonIcon: 'Plus' },
  { to: '/dashboard/forms', label: 'Forms', icon: 'FileText', title: 'Registration Forms', sub: '7 forms — 4 currently open', buttonText: 'New Form', buttonIcon: 'Plus' },
