...
import { X, GripVertical, Check, Trash2, Loader2 } from "lucide-react";
...
function FieldRow({ field, index, updateFieldAt, removeFieldAt, errors }) {
      ...
      <div className="flex items-start gap-2 px-5 py-3">
        ...
        <div className="flex-1 min-w-0">
          <input
            ...
            className="w-full rounded-lg border border-border bg-input px-3 py-2 text-sm text-foreground placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors"
          />
              ...
              {(field.options || []).map((opt, oi) => (
                <div key={oi} className="flex items-center gap-1.5">
                  <input
                    ...
                    className="flex-1 rounded-md border border-border bg-input px-2.5 py-1.5 text-xs text-foreground placeholder:text-muted focus:outline-none focus:ring-1 focus:ring-primary/30"
                  />
                  <button
                    type="button"
        ...
        <select
          ...
          className="w-[130px] shrink-0 rounded-lg border border-border bg-input px-2.5 py-2 text-xs text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30"
        >
...
export default function CreateForm() {
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 flex justify-center">
      <div className="w-full max-w-[700px] bg-card-alt rounded-xl border border-border shadow-sm">
        ...
        <div className="p-6 space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-input px-4 py-2.5 text-sm text-foreground placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors"
            />
            {errors?.title && (
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-lg border border-border bg-input px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-lg border border-border bg-input px-4 py-2.5 text-sm text-foreground placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors resize-none"
            />
          </div>

          <div>
            <label
              htmlFor="form-linked-event"
              className="block text-sm font-semibold text-foreground mb-1.5"
            >
              Linked Event{" "}
              <span className="text-muted font-normal">(optional)</span>
            ...
            <input
              id="form-linked-event"
              type="text"
              value={formData.linkedEvent || ""}
              onChange={(e) => updateField("linkedEvent", e.target.value)}
          ...
          <div>
            ...
            <div className="rounded-xl border border-border overflow-hidden">
              <div className="hidden sm:flex items-center gap-2 px-5 py-2 bg-gray-50 dark:bg-gray-800/50 border-b border-border">
              ...
              <div className="flex items-center gap-2 px-5 py-3 border-t border-border">
                <input
                  ...
                  className="flex-1 rounded-lg border border-border bg-input px-3 py-2 text-sm text-foreground placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-primary/30 transition-colors"
                />
                <select
                  value={newFieldType}
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-border">
          <button
            type="button"
            onClick={() => navigate("/dashboard/forms")}
            className="px-4 py-2 text-sm font-medium text-foreground bg-transparent border border-border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
          >
            Cancel
          </button>
          <button
