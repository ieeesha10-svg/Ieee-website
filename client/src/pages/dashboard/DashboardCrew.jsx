...
import { Plus, Trash2, Edit, Loader2, Users, Search, X } from "lucide-react";
...
function Modal({ open, onClose, title, children, maxWidth = "max-w-lg" }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      />
      <div
        className={`relative bg-white dark:bg-[#1a1f2e] rounded-xl border border-gray-100 dark:border-[#222936] shadow-xl w-full ${maxWidth} max-h-[90vh] overflow-y-auto`}
      >
