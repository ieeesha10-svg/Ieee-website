        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted leading-relaxed">
              Pick the one that fits you best. Not required for guests — you can
          ...
          <div className="space-y-2">
            <span className="text-sm font-semibold text-foreground">
              2. Your request is sent to our team
            </span>
            <p className="text-sm text-muted leading-relaxed">
          ...
          <div className="space-y-2">
            <span className="text-sm font-semibold text-foreground">
              3. Our team reviews it
            </span>
            <p className="text-sm text-muted leading-relaxed">
              A team member will approve your request and welcome you into the
              committee. You'll know when it's confirmed.
            </p>
          </div>
        </div>
      </Modal>
